<template>
  <div class="app-container">
    ...
    <!-- 弹出层 -->
    <el-dialog title="请编辑信息" :visible.sync="dialogFormVisible" width="50%" top="5vh" fullscreen>
      <el-form :model="form">
...
export default {
  ...
  data() {
    return {
      resourceServer: process.env.VUE_APP_RES_URL,
      form: {
        avatar: '',
        favicon: '',
        github: '',
  ...
  methods: {
    fetchData() {
      getSetting().then(res => {
        this.form = res.data
        // 处理图片的链接
        // this.form.avatar2 = resourceServer  + this.form.avatar;
        // this.form.qqQrCode2 = resourceServer  + this.form.qqQrCode;
        // this.form.weixinQrCode2 = resourceServer  + this.form.weixinQrCode;
